...
- [Better Auth setup for auth.konker.dev](#better-auth-setup-for-authkonkerdev)
  - [Goals](#goals)
  ...
  - [Plugin configuration](#plugin-configuration)
    ...
    - [Two-factor plugin](#two-factor-plugin)
    - [Optional: multi-session](#optional-multi-session)
