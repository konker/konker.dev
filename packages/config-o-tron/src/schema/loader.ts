...
import { type ConfigOTronError, fileNotFoundError, type SystemError, type ValidationError } from '../errors.js';
...
): Effect.Effect<SchemaLoadResult, SystemError | ValidationError | ConfigOTronError> {
