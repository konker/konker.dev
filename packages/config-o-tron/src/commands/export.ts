...
): Effect.Effect<ExportResult, ProviderError | ValidationError | SystemError | ConfigOTronError | Error> {
  return pipe(
    // 1. Load schema
...
export function runExport(
  options: ExportOptions
): Effect.Effect<void, ProviderError | ValidationError | SystemError | ConfigOTronError | Error> {
  return pipe(
