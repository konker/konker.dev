...
import * as unit from './basic-auth.js';
...
describe('basic-auth', () => {
  ...
  describe('basicAuthDecodeHeaderValue', () => {
    ...
    it('should fail as expected with undefined input', () => {
      ...
      expect(provide(actual, undefined)._unsafeUnwrapErr()).toBeInstanceOf(Error);
    });
    ...
    it('should fail as expected with invalid basic auth payload', () => {
      const actual = unit.basicAuthDecodeHeaderValue('bm9jb2xvbg==');
      expect(provide(actual, undefined)._unsafeUnwrapErr().message).toBe('Invalid basic auth payload');
    });
  });
  ...
  describe('basicAuthEncodeHeaderValue', () => {
    it('should work as expected with valid input', () => {
      ...
      expect(provide(actual, undefined)._unsafeUnwrap()).toStrictEqual('Basic Zm9vOmJhcg==');
    });
  });
  ...
  describe('basicAuthVerifyCredentials', () => {
    ...
    it('should work as expected in the positive case without a user id', () => {
    ...
    it('should work as expected in the negative case with the wrong user', () => {
