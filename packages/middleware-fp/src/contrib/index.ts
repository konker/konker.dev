export * as awsApiGatewayProcessor from './awsApiGatewayProcessor.js';
export * as awsIamAuthorizerProcessor from './awsIamAuthorizerProcessor.js';
export * as awsSimpleAuthorizerProcessor from './awsSimpleAuthorizerProcessor.js';
...
export * as dynamodbDocClientInit from './dynamodbDocClientInit/index.js';
