...
[@konker.dev/neverthrow-r-utils](../../../modules.md) / [stream/PromiseDependentWritableStream](../README.md) / PromiseDependentWritableStream

# Class: PromiseDependentWritableStream

Defined in: [packages/neverthrow-r-utils/src/stream/PromiseDependentWritableStream.ts:9](https://github.com/konker/konker.dev/blob/main/packages/neverthrow-r-utils/src/stream/PromiseDependentWritableStream.ts#L9)
...
`PromiseDependentWritableStream`
...
Defined in: [packages/neverthrow-r-utils/src/stream/PromiseDependentWritableStream.ts:10](https://github.com/konker/konker.dev/blob/main/packages/neverthrow-r-utils/src/stream/PromiseDependentWritableStream.ts#L10)
...
Calling [read](../../ChildProcessStreamPipe/classes/ChildProcessStreamPipe.md#read) after the `'end'` event has
...
Unlike [push](../../ChildProcessStreamPipe/classes/ChildProcessStreamPipe.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [\_read](../../ChildProcessStreamPipe/classes/ChildProcessStreamPipe.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](../../ChildProcessStreamPipe/classes/ChildProcessStreamPipe.md#push) will reset the reading state appropriately,
