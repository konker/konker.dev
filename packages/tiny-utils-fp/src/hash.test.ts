...
describe('index', () => {
  describe('md5Hex', () => {
    it('should work as expected', () => {
      const actual = unit.md5Hex('test').pipe(Effect.runSync);
  ...
  describe('sha256Hex', () => {
    it('should work as expected', () => {
      const actual = unit.sha256Hex('test').pipe(Effect.runSync);
  ...
  describe('sha256HmacHex', () => {
    it('should work as expected', () => {
      const actual = unit.sha256HmacHex('test', 'secret').pipe(Effect.runSync);
